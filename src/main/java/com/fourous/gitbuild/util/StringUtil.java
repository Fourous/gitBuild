...
public abstract class StringUtil {
    ...
    /**
     * 生成uuid给定len，需要指定长度，如果取值小于0或者大于等于32时，返回32个字符的UUID
     *
     * @param len
     * @return
     */
    public static String generateUUID(int len) {
        ...
        int index = uuid.length() - len;
        if (index < 0 || index >= length) {
            index = 0;
        }
        uuid = uuid.substring(index);
        return uuid;
    }
    ...
    public static boolean isNotNull(String str) {
        ...
        result = (str != null && str.trim().length() > 0);
        return result;
    }
     ...
     * @return
     */
    public static String generateStr(int length, String s) {
    ...
    /**
     * 判断字符串是否有效，且是否等于参数param，相等返回true
     *
     * @param str
     * @param param
     * @return
     */
    public static boolean isEqualParam(String str, String param) {
        boolean result = false;
        result = isNotNull(str) && str.equals(param);
        return result;
    }
    ...
    public static String toString(Object obj) {
        return StringUtil.isNullOrEmpty(obj) ? "" : obj.toString();
    }

    public static Long toLong(Object obj) {
        return StringUtil.isNullOrEmpty(obj) ? null : Long.parseLong(obj.toString());
    }

    public static Date toDate(Object obj) {
        return StringUtil.isNullOrEmpty(obj) ? null : (Date) obj;
    }

    public static Date toDates(Object obj) throws Exception {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        return StringUtil.isNullOrEmpty(obj) ? null : sdf.parse(obj.toString());
    }

    public static Short toShort(Object obj) {
        return StringUtil.isNullOrEmpty(obj) ? null : Short.parseShort(obj.toString());
    }

    public static Integer toInteger(Object obj) {
        return StringUtil.isNullOrEmpty(obj) ? null : Integer.parseInt(obj.toString());
    }

    public static BigDecimal toBigDecimal(Object obj) {
        return StringUtil.isNullOrEmpty(obj) ? null : new BigDecimal(obj.toString());
    }
}
